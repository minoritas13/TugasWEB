...
<body class="bg-gray-100">
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-white shadow-lg px-4 py-6">
            <h2 class="text-xl font-bold text-green-600 mb-6">Admin Menu</h2>
            <ul class="space-y-3">
                <li>
                    <a href="<?= BASEURL; ?>/dashboardAdmin/tambah" class="block bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">Tambah Barang</a>
                </li>
                <li>
                    <a href="<?= BASEURL; ?>/transaksi" class="block bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">Lihat Transaksi</a>
                </li>
                <li>
                    <a href="<?= BASEURL; ?>/logout" class="block bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600">Logout</a>
                </li>
            </ul>
        </aside>
